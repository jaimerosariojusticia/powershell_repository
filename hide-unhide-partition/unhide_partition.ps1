...
if ($PSVersionTable.PSVersion.Major -le 4)
    { Get-Disk | Where-Object SerialNumber -EQ $SERIAL | Get-Partition | Where-Object PartitionNumber  -EQ $PN | Set-Partition -IsHidden $false }
else
    { Get-Disk -SerialNumber $SERIAL | Set-Partition -PartitionNumber $PN -IsHidden $false }